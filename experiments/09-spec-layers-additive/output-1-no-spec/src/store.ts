...
export type Activity = {
  ...
  mergedFrom?: string[];      // titles of activities that were absorbed into this one
  mergedParticipants?: string[]; // names of participants whose activities were merged in
};
