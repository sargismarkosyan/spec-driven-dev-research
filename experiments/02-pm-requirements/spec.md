...
> User stories and acceptance criteria only. No technical detail. Every screen, interaction, and behavior captured from the full product design.
...
- As an engineer, I can see what my teammates are submitting in real time in a right-side team feed panel, titled something like "Have you got these too?" or similar.
