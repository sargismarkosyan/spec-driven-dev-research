...
**File location in project:** `skills/find-best-opportunities/SKILL.md`
...
- **Energy:** draining / tedious / fine / energizing (wire values from [enumerations.md](../02-data-model/enumerations.md))
